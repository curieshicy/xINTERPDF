...
class C_InterPDF():
    ...
    #########These are parameters for molecules###############
        ...
        for i, j in enumerate(self.mole_elements_list):
            ...
            uiso_m_entry = ttk.Entry(self.panel_tab_1, width = 6, font = ("Times", 12),
        ...
        for i, j in enumerate(self.cryst_elements_list):
            ...
            uiso_c_entry = ttk.Entry(self.panel_tab_2, width = 6, font = ("Times", 12), textvariable = getattr(self, "ft_cryst_{}_Uiso".format(j)))
        ...
        ee1 = ttk.Entry(self.panel_tab_3, width = 6, font = ("Times", 12),textvariable = self.Y_scale_entry)
...
class A_InterPDF():
    ...
    #########These are parameters for molecules###############
        ...
        ee1 = ttk.Entry(self.panel_tab_2, width = 6, font = ("Times", 12),textvariable = self.Y_scale_entry)
        ee1.grid(row = 0, column = 8, columnspan = 2, padx = 5, sticky = "sw")
        ee1.bind("<Return>", self.update_plot_fine_tune_para)
...
#        self.rstep_2_entry.set(0.01)
        ...
        ee2 = ttk.Entry(self.panel_tab_3, width = 6, font = ("Times", 12),textvariable = self.mol_1_Y_scale_entry)
        ...
        ee3 = ttk.Entry(self.panel_tab_3, width = 6, font = ("Times", 12),textvariable = self.mol_2_Y_scale_entry)
