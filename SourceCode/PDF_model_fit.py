...
class PDF_model_fit():
    def __init__(self, master):
        ...
        self.style.configure('TButton', background = 'grey91', font = ("Arial", 14, "bold"))
        ...
        ttk.Label(self.master, text = "To perform a fit to crystalline organic PDF, one needs to prepare a structure file for the single molecule.\n"
            "In addition, a crystal structure for compound is needed as input.", font = ("Arial", 14, "bold"), justify = CENTER).pack(side = TOP)
        self.top_frame = ttk.Frame(self.master, padding = (10, 10))
        self.top_frame.pack()
        
        ##here are the layout for step 1, load structure files

        ttk.Label(self.top_frame, text = "S1:Load Structures", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 0, column = 0, columnspan = 2, padx = 5, sticky = "sw")
        ...
        ttk.Label(self.top_frame, text = "S2:Set Parameters", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 2, column = 0, columnspan = 2, padx = 5, sticky = "sw")        
        ...
        ttk.Label(self.top_frame, text = "Qdamp", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 0, columnspan = 1, padx = 5, sticky = "sw")
        ...
        ttk.Label(self.top_frame, text = "Qbroad", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 3, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8,font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Uiso_intra", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 6, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Uiso_inter", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 9, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Qmin", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 12, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Qmax", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 3, column = 15, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Lat_a", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 0, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Lat_b", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 3, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8,font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Lat_c", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 6, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Alpha", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 9, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Beta", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 12, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Gamma", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 4, column = 15, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Scale", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 0, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Zoom_Mol", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 3, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8,font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Zoom_Intra", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 6, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Delta2_Cryst", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 9, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Delta2_Mol", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 12, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "Delta2_Intra", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 5, column = 15, columnspan = 1, padx = 5, sticky = "sw")
        ttk.Entry(self.top_frame, width = 8, font = ("Arial", 10),
        ...
        ttk.Label(self.top_frame, text = "S3:Select Optimzers", justify = CENTER,
                  font = ("Arial", 14, "bold")).grid(row = 6, column = 0, columnspan = 2, padx = 5, sticky = "sw")
    ...
    ###the bottom frame, the interactive matplotlib canvas for interactive plot/visualization
        ...
        self.fig = plt.figure(figsize=(11, 5), dpi=100) ##create a figure; modify the size here
        self.fig.add_subplot()
    
        plt.title("PDF Model Fit To Crystalline Organic PDF")
        plt.xlabel("r $(\AA)$", labelpad = 20, fontsize = 15)
        plt.ylabel("PDF, G $(\AA^{-2})$", labelpad = 20, fontsize = 15)
