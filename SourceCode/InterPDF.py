...
class InterPDF():
    ...
    def load_mol_uiso_elements(self):
        ...
        for i, j in enumerate(self.mole_elements_list):
            ...
            ttk.Entry(self.tab_1, width = 8, font = ("Arial", 12),
                textvariable = getattr(self, "mol_{}_Uiso".format(j))).grid(row = 3+i, column = 8, columnspan = 1, padx = 5, sticky = "sw")
            ttk.Entry(self.tab_1, width = 8, font = ("Arial", 12),
                textvariable = getattr(self, "mol_{}_Occ".format(j))).grid(row = 3+i, column = 9, columnspan = 1, padx = 5, sticky = "sw")
    ...
    def load_cryst_uiso_elements(self):
        ...
        for i, j in enumerate(self.cryst_elements):
            ...
            ttk.Entry(self.tab_2, width = 8, font = ("Arial", 12),
                textvariable = getattr(self, "cryst_{}_Uiso".format(j))).grid(row = 3+i, column = 8, columnspan = 1, padx = 5, sticky = "sw")
            ttk.Entry(self.tab_2, width = 8, font = ("Arial", 12),
                textvariable = getattr(self, "cryst_{}_Occ".format(j))).grid(row = 3+i, column = 9, columnspan = 1, padx = 5, sticky = "sw")
